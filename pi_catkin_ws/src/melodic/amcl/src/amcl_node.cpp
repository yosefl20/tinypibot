...
AmclNode::AmclNode()
  ...
  laser_scan_filter_->registerCallback(
      boost::bind(&AmclNode::laserReceived, this, boost::placeholders::_1));
  initial_pose_sub_ =
  ...
  dynamic_reconfigure::Server<amcl::AMCLConfig>::CallbackType cb =
      boost::bind(&AmclNode::reconfigureCB, this, boost::placeholders::_1,
                  boost::placeholders::_2);
  dsrv_->setCallback(cb);

  // 15s timer to warn on lack of receipt of laser scans, #5209
  laser_check_interval_ = ros::Duration(15.0);
  check_laser_timer_ = nh_.createTimer(
      laser_check_interval_, boost::bind(&AmclNode::checkLaserReceived, this,
